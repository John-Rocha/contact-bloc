...
mixin _$ContactUpdateEvent {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(String id, String name, String email) update,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function(String id, String name, String email)? update,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$_Update implements _Update {
  const _$_Update({required this.id, required this.name, required this.email});
...
abstract class _Update implements ContactUpdateEvent {
  const factory _Update(
      ...
      required final String email}) = _$_Update;
